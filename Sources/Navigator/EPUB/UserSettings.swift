...
public class UserSettings {
    ...
    private let fontFamilyValues = ["Original", "Literata", "Helvetica Neue", "Iowan Old Style", "Athelas", "Seravek", "OpenDyslexic", "AccessibleDfA", "IA Writer Duospace", "Atkinson Hyperlegible"]
    // START Aldiko
